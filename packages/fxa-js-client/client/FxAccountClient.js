...
define([
   ...
   * @return {Promise} A promise that will be fulfilled with JSON `xhr.responseText` of the request
   */
  FxAccountClient.prototype.attachedClientDestroy = function (sessionToken, clientInfo) {
    var self = this;
    var data = {
    ...
    return Promise.resolve()
      ...
      .then(function (creds) {
        return self.request.send('/account/attached_client/destroy', 'POST', creds, data);
      });
  };
